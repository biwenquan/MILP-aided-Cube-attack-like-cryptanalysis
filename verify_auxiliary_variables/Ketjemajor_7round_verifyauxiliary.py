...
state[6][0]=Keccak(k(3))
state[6][1]=Keccak(k(4))
state[6][2]=Keccak(k(5))
state[6][3]=Keccak(k(6))
state[6][4]=Keccak(k(7))
state[6][5]=Keccak(k(8))
state[6][6]=Keccak(k(9))
state[6][7]=Keccak(k(10))
state[6][8]=Keccak(k(11))
state[6][9]=Keccak(k(12))
state[6][10]=Keccak(k(13))
state[6][11]=Keccak(k(14))
state[6][12]=Keccak(k(15))
state[6][13]=Keccak(k(16))
state[6][14]=Keccak(k(17))
state[6][15]=Keccak(k(18))
state[6][16]=Keccak(k(19))
state[6][17]=Keccak(k(20))
state[6][18]=Keccak(k(21))
state[6][19]=Keccak(k(22))
state[6][20]=Keccak(k(23))
state[6][21]=Keccak(k(24))
state[6][22]=Keccak(k(25))
state[6][23]=Keccak(k(26))
state[6][24]=Keccak(k(27))
state[6][25]=Keccak(k(28))
state[6][26]=Keccak(k(29))
state[6][27]=Keccak(k(30))
state[6][28]=Keccak(k(31))





state[16][0]=Keccak(k(3)+v(19))
state[16][1]=Keccak(k(4))
state[16][2]=Keccak(k(5)+v(20))
state[16][3]=Keccak(k(6))
state[16][4]=Keccak(k(7)+v(21))
state[16][5]=Keccak(k(8))
state[16][6]=Keccak(k(9)+v(22))
state[16][7]=Keccak(k(10))
state[16][8]=Keccak(k(11))
state[16][9]=Keccak(k(12))
state[16][10]=Keccak(k(13)+v(23))
state[16][11]=Keccak(k(14))
state[16][12]=Keccak(k(15))
state[16][13]=Keccak(k(16)+v(24))
state[16][14]=Keccak(k(17))
state[16][15]=Keccak(k(18)+v(25))
state[16][16]=Keccak(k(19))
state[16][17]=Keccak(k(20)+v(26))
state[16][18]=Keccak(k(21)+v(27))
state[16][19]=Keccak(k(22))
state[16][20]=Keccak(k(23)+v(28))
state[16][21]=Keccak(k(24))
state[16][22]=Keccak(k(25)+v(29))
state[16][23]=Keccak(k(26)+v(30))
state[16][24]=Keccak(k(27)+v(31))
state[16][25]=Keccak(k(28)+v(32))
state[16][26]=Keccak(k(29)+v(33))
state[16][27]=Keccak(k(30)+v(34))
state[16][28]=Keccak(k(31)+v(35))
