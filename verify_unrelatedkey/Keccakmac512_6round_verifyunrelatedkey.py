...
state[0][3]=Keccak(k(2))
state[0][4]=Keccak(k(3))
state[0][9]=Keccak(k(4))
state[0][10]=Keccak(k(5))
state[0][11]=Keccak(k(6))
state[0][12]=Keccak(k(7))
state[0][17]=Keccak(k(8))
state[0][18]=Keccak(k(9))
state[0][19]=Keccak(k(10))
state[0][20]=Keccak(k(11))
state[0][21]=Keccak(k(12))
state[0][23]=Keccak(k(13))
state[0][26]=Keccak(k(14))
state[0][27]=Keccak(k(15))
state[0][28]=Keccak(k(16))
state[0][29]=Keccak(k(17))
state[0][30]=Keccak(k(18))
state[0][35]=Keccak(k(19))
state[0][36]=Keccak(k(20))
state[0][37]=Keccak(k(21))
state[0][38]=Keccak(k(22))
state[0][43]=Keccak(k(23))
state[0][44]=Keccak(k(24))
state[0][45]=Keccak(k(25))
state[0][46]=Keccak(k(26))
state[0][49]=Keccak(k(27))
state[0][51]=Keccak(k(28))
state[0][52]=Keccak(k(29))
state[0][53]=Keccak(k(30))
state[0][58]=Keccak(k(31))
state[0][59]=Keccak(k(32))
state[0][60]=Keccak(k(33))
state[0][61]=Keccak(k(34))
...
state[1][9]=Keccak(k(41))
state[1][10]=Keccak(k(42))
state[1][11]=Keccak(k(43))
state[1][12]=Keccak(k(44))
state[1][13]=Keccak(k(45))
state[1][17]=Keccak(k(46))
state[1][19]=Keccak(k(47))
state[1][20]=Keccak(k(48))
state[1][21]=Keccak(k(49))
state[1][23]=Keccak(k(50))
state[1][26]=Keccak(k(51))
state[1][27]=Keccak(k(52))
state[1][28]=Keccak(k(53))
state[1][29]=Keccak(k(54))
state[1][32]=Keccak(k(55))
state[1][35]=Keccak(k(56))
state[1][36]=Keccak(k(57))
state[1][37]=Keccak(k(58))
state[1][39]=Keccak(k(59))
state[1][43]=Keccak(k(60))
state[1][44]=Keccak(k(61))
state[1][45]=Keccak(k(62))
state[1][46]=Keccak(k(63))
state[1][47]=Keccak(k(64))
state[1][49]=Keccak(k(65))
state[1][51]=Keccak(k(66))
state[1][52]=Keccak(k(67))
state[1][53]=Keccak(k(68))
state[1][54]=Keccak(k(69))
state[1][55]=Keccak(k(70))
state[1][58]=Keccak(k(71))
state[1][59]=Keccak(k(72))
state[1][60]=Keccak(k(73))
state[1][61]=Keccak(k(74))
state[1][62]=Keccak(k(75))
